...
export const Topbar = tw.div`md:flex justify-start space-x-3 items-center px-1 my-2 text-xl font-bold text-gray-700`;
...
export const AllReply = tw.div`flex items-start  space-x-2 shadow p-3 rounded-lg my-4`;
